<template OverwriteFlag="true" DocrootFlag="false" DirectorySuffix="" TargetDirectory="<?php echo __META_CONTROLS_GEN__  ?>" TargetFileName="<?php echo $objTable->ClassName  ?>ViewPanelGen.class.php"/>
<?php print("<?php\n"); ?>
...
<?php } ?>
		...
		public function __construct($objParentObject, $obj<?php echo $objTable->ClassName ?>Ref = null, $blnShowPk = true, $strControlId = null) {
			...
			$this->CssClass = 'ui-widget <?php echo QConvertNotation::UnderscoreFromCamelCase($objTable->ClassName) ?>_view_panel view_panel';
